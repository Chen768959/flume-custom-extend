 ...
 * @date 2021/6/22
 */
public class AppData2 extends BaseData implements Data{
  ...
  private final Map.Entry<String, Object> entryEvents_DTD_timestamp;
  private final Map.Entry<String, Object> entryEvents_DTD_eventParams;
  private final Map.Entry<String, Object> entryEvents_DTD_eventParams_type;
  private final Map<String, Object> mapEvents_DTD_eventParams;
  ...
  public AppData2(){
    this.appData = new HashMap<String,Object>(){{
      ...
      put("Events",new ArrayList<Map<String,Object>>(){{
        add(new HashMap<String,Object>(){{
          put("EID","kesheng_event");
          put("OCID","ceshieOCID");
          put("ETM","1624236617392");
          put("TDT",new ArrayList<Map<String,Object>>(){{
            add(new HashMap<String,Object>(){{
              put("EK","eventName");
              put("EV","native_action");
            }});
            add(new HashMap<String,Object>(){{
              put("EK","timestamp");
              put("EV","1624241818380");
            }});
            add(new HashMap<String,Object>(){{
              put("EK","eventParams");
              put("EV",new HashMap<String,Object>(){{
                ...
                put("extra",new HashMap<String,Object>(){{
                  put("originalActionType","JUMP_DETAIL_PAGE");
                }});
              }});
            }});
          }});
    ...
    this.entryEvents_DTD_timestamp = getEntryByEK(tdt,"timestamp");

    this.entryEvents_DTD_eventParams = getEntryByEK(tdt, "eventParams");
    this.mapEvents_DTD_eventParams = (Map<String, Object>)getEntryByEK(tdt, "eventParams").getValue();
    this.entryEvents_DTD_eventParams_type = getEntryByKey(mapEvents_DTD_eventParams,"type");
  }
  ...
  public void makingRandom() throws JsonProcessingException {
    ...
    this.entryEvents_DTD_timestamp.setValue(RandomUtil.getTime());
    this.entryEvents_DTD_eventParams_type.setValue(RandomUtil.getEVtype());

    this.entryEvents_DTD_eventParams.setValue(objectMapper.writeValueAsString(this.mapEvents_DTD_eventParams));
  }
}
